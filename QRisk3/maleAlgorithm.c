 ...
 * along with QRISK3-2017.  If not, see <a href='http://www.gnu.org/licenses/'>http://www.gnu.org/licenses/</a>.
 *
 * Additional terms
 *
 ...
 * The initial version of this file, to be found at https://github.com/endeavour-predict/EP-Open-source, which faithfully implements QRISK3-2017.
 * Endeavour Predict CIC Have released this code under the GNU Lesser General Public License to enable others to implement the algorithm faithfully.
 * Changes to the code may be made since the original release, and Endeavour Predict CIC cannot guarantee that the code you are using is a faithful implementation of QRISK3-2017.
 * It is the responsibility of the manufacturer of your device to ensure that the code you are using is a faithful implementation of QRISK3-2017, and that it produces the same
