 ...
 *
 *
 * QRISK3 is licensed for use under the GMU Lesser General Public license
 *
 * QRISK3  is distributed in the hope that it will be useful,
 * but WITHOUT ANY WARRANTY; without even the implied warranty of
 * MERCHANTABILITY or FITNESS FOR A PARTICULAR PURPOSE.  See the
 * GNU Lesser General Public License for more details.
 * Copy of the license is at https://github.com/endeavour-predict/EP-Open-source/blob/main/LICENSE
 * Additional terms
 *
 ...
 *   The initial version of this file, to be found at https://github.com/endeavour-predict/EP-Open-source/tree/main/QRisk3 faithfully implements QRISK3-2017.
 ...
 *   It is the responsibility of the end user to check that the score that they receive produces the same
